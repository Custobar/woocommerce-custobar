...
use Sofokus\WooCommerceCustobar\DataType\CustobarSale;
use Sofokus\WooCommerceCustobar\DataType\Utilities;
...
{
    protected static $endpoint = 'https://%s.custobar.com/api/sales/upload/';
